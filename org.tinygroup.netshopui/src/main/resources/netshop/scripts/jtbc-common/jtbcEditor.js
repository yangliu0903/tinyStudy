function jtbcEditor(_id)
{
  ...
  this.tToolbarSets['default'] = ['Bold','Italic','Underline','RemoveFormat','separator','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','separator','OrderedList','UnorderedList'];
