package org.tinygroup.secondaction.action.impl;
...
import org.tinygroup.secondaction.action.SecondAction;

public class SecondActionWrapper implements  SecondAction{
	...
	public void prepare_add(BusinessActionContext businessActionContext,
			String accountNo, double amount) {
		String serviceId = "prepare_add";
