...
public class UserServiceImplWrapper implements top.develop.demo.service.UserService<top.develop.demo.pojo.UserPojo> {
	...
	public void addUser(top.develop.demo.pojo.UserPojo user) {
	...
	public void updateUser(top.develop.demo.pojo.UserPojo user) {
	...
	public top.develop.demo.pojo.UserPojo getUserById(java.lang.String id) {
	...
	public java.util.List<top.develop.demo.pojo.UserPojo> queryUsers(top.develop.demo.pojo.UserPojo pojo) {
